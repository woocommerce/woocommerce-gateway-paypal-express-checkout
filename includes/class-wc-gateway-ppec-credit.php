...
class PayPal_Credit_Gateway extends PayPal_Express_Checkout_Gateway {
	public function __construct() {
		...
		$this->method_title       = __( 'PayPal Credit', 'woocommerce-gateway-paypal-express-checkout' );
		$this->method_description = __( 'Make checkout quick and easy for your buyers, and give them an easy way to finance their purchases at the same time.', 'woocommerce-gateway-paypal-express-checkout' );
	}
