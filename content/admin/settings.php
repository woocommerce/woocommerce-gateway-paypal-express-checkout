...
?><h3><?php _e( 'PayPal Configuration', 'woo_pp' ); ?></h3>
<?php
if ( $live_cert ) {
	?>
...
<table class="form-table">
	<tr>
		<th>
			<label for="woo_pp_enabled"><?php _e( 'Enable/Disable', 'woo_pp' ); ?></label>
			<a href="#TB_inline?width=800&height=600&inlineId=woo_pp_enabled_help" class="thickbox"><img src="<?php echo $help_image_url; ?>" class="help_tip" style="cursor: pointer;" height="16" width="16" data-tip="<?php _e( 'Click here for help with this option.', 'woo_pp' ); ?>"></a>
		</th>
		<td>
			<div id="woo_pp_enabled_help" style="display: none;">
				<p>
					<h2><?php _e( 'Enable PayPal Express Checkout', 'woo_pp' ); ?></h2>
					<?php _e( '<p>If this setting is enabled, buyers will be allowed to pay for their purchases using PayPal Express Checkout.</p>', 'woo_pp' ); ?>
				</p>
			</div>
			<fieldset>
				<legend class="screen-reader-text"><span><?php _e( 'Enable PayPal Express Checkout', 'woo_pp' ); ?></span></legend>
				<input type="checkbox" name="woo_pp_enabled" id="woo_pp_enabled" value="true"<?php checked( $enabled ); ?>>
				<label for="woo_pp_enabled"><?php _e( 'Enable PayPal Express Checkout', 'woo_pp' ); ?></label>
			</fieldset>
		</td>
	</tr>
	<tr>
		<th>
			<label for="woo_pp_ppc_enabled"><?php _e( 'PayPal Credit', 'woo_pp' ); ?></label>
			<a href="#TB_inline?width=800&height=600&inlineId=woo_pp_ppc_enabled_help" class="thickbox"><img src="<?php echo $help_image_url; ?>" class="help_tip" style="cursor: pointer;" height="16" width="16" data-tip="<?php _e( 'Click here for help with this option.', 'woo_pp' ); ?>"></a>
		</th>
		<td>
			<div id="woo_pp_ppc_enabled_help" style="display: none;">
				<p>
					<h2><?php _e( 'Enable PayPal Credit', 'woo_pp' ); ?></h2>
					<?php _e( '<p>PayPal Credit allows you a convenient way to offer financing to your customers, without exposing your business to the additional risk typically involved with seller financing.  Offer your buyers a convenient way to finance their purchases with a single click!</p><p>If this setting is enabled, the PayPal Credit button will be shown to buyers on the shopping cart page:</p><div style="text-align: center;"><img src="https://www.paypalobjects.com/webstatic/en_US/i/buttons/ppcredit-logo-small.png" width="148" height="26" alt="PayPal Credit button"></div><p>When buyers click on this button, they are taken to PayPal and invited to sign up for PayPal Credit (if they are not already signed up) and to pay for their purchase using PayPal Credit.  The transaction appears no differently to you than a normal PayPal transaction &mdash; you still receive the proceeds from the transaction immediately, as you normally would.</p><p><strong>Note:</strong> PayPal recommends that you enable this option.  However, PayPal Credit is available primarily to users in the United States; if most of your buyers come from outside the United States, you may want to disable this option.</p>', 'woo_pp' ); ?>
				</p>
			</div>
			<fieldset>
				<legend class="screen-reader-text"><span><?php _e( 'Enable PayPal Credit', 'woo_pp' ); ?></span></legend>
				<input type="checkbox" name="woo_pp_ppc_enabled" id="woo_pp_ppc_enabled" value="true"<?php checked( $ppc_enabled ); ?>>
				<label for="woo_pp_ppc_enabled"><?php _e( 'Enable PayPal Credit', 'woo_pp' ); ?></label>
			</fieldset>
		</td>
	<tr>
		<th>
			<label for="woo_pp_environment"><?php _e( 'Environment', 'woo_pp' ); ?></label>
			<a href="#TB_inline?width=800&height=600&inlineId=woo_pp_environment_help" class="thickbox"><img src="<?php echo $help_image_url; ?>" class="help_tip" style="cursor: pointer;" height="16" width="16" data-tip="<?php _e( 'Click here for help with this option.', 'woo_pp' ); ?>"></a>
		</th>
		<td>
			<div id="woo_pp_environment_help" style="display: none;">
				<p>
					<h2><?php _e( 'Environment', 'woo_pp' ); ?></h2>
					<?php _e( '<p>This setting specifies whether you will process live transactions, or whether you will process simulated transactions using the PayPal Sandbox.</p><ul style="list-style: disc inside;"><li>If you set this to <strong>Live</strong>, your site will process live transactions using the live PayPal site.</li><li>If you set this to <strong>Sandbox</strong>, transactions will be simulated using the PayPal Sandbox.</li></ul><p>To get started with the PayPal Sandbox, go to <a href="https://developer.paypal.com" target="_blank">https://developer.paypal.com</a>.</p><p><strong>Note:</strong> The PayPal Sandbox is completely isolated from the live site.  If you have a PayPal account onthe live PayPal site, it does not necessarily mean that you have an account on the PayPal Sandbox, and vice-versa.  For this reason, we maintain two separate sets of API credentials for you &mdash; one set for the live site, and one set for the Sandbox.</p>', 'woo_pp' ); ?>
				</p>
			</div>
			<fieldset>
				<legend class="screen-reader-text"><span><?php _e( 'Environment', 'woo_pp' ); ?></span></legend>
				<select name="woo_pp_environment" id="woo_pp_environment">
					<option value="live"<?php selected( $environment, 'live' ) ?>><?php _e( 'Live', 'woo_pp' ); ?></option>
					<option value="sandbox"<?php selected( $environment, 'sandbox' ) ?>><?php _e( 'Sandbox', 'woo_pp' ); ?></option>
				</select>
			</fieldset>
		</td>
	</tr>
...
<?php } ?>
	...
	<tr class="woo_pp_live">
		<th>
			<label for="woo_pp_live_api_username"><?php _e( 'Live API username', 'woo_pp' ); ?></label>
			<a href="#TB_inline?width=800&height=600&inlineId=woo_pp_live_api_username_help" class="thickbox"><img src="<?php echo $help_image_url; ?>" class="help_tip" style="cursor: pointer;" height="16" width="16" data-tip="<?php _e( 'Click here for help with this option.', 'woo_pp' ); ?>"></a>
		</th>
		<td>
			<div id="woo_pp_live_api_username_help" style="display: none;">
				<p>
					<h2><?php _e( 'Live API username', 'woo_pp' ); ?></h2>
					<?php _e( '<p>Enter the API username provided to you by PayPal.</p><p><strong>Note:</strong> This value is generated for you by PayPal.  You must use the username that they give you.  This is <strong>not</strong> the same as the email address you use to log in to <a href="https://www.paypal.com" target="_blank">www.paypal.com</a>.</p><p>For help on retrieving your API credentials, click on the help for the <strong>Live API credential type</strong> setting.</p>', 'woo_pp' ); ?>
				</p>
			</div>
			<fieldset>
				<legend class="screen-reader-text"><span><?php _e( 'Live API username', 'woo_pp' ); ?></span></legend>
	...
	<tr class="woo_pp_live">
		<th>
			<label for="woo_pp_live_api_password"><?php _e( 'Live API password', 'woo_pp' ); ?></label>
			<a href="#TB_inline?width=800&height=600&inlineId=woo_pp_live_api_password_help" class="thickbox"><img src="<?php echo $help_image_url; ?>" class="help_tip" style="cursor: pointer;" height="16" width="16" data-tip="<?php _e( 'Click here for help with this option.', 'woo_pp' ); ?>"></a>
		</th>
		<td>
			<div id="woo_pp_live_api_password_help" style="display: none;">
				<p>
					<h2><?php _e( 'Live API password', 'woo_pp' ); ?></h2>
					<?php _e( '<p>Enter the API password provided to you by PayPal.</p><p><strong>Note:</strong> This value is generated for you by PayPal.  You must use the password that they give you.  This is <strong>not</strong> the same as the password you use to log in to <a href="https://www.paypal.com" target="_blank">www.paypal.com</a>.</p><p>For help on retrieving your API credentials, click on the help for the <strong>Live API credential type</strong> setting.</p>', 'woo_pp' ); ?>
				</p>
			</div>
			<fieldset>
	...
	<tr class="woo_pp_live_signature">
		<th>
			<label for="woo_pp_live_api_signature"><?php _e( 'Live API signature', 'woo_pp' ); ?></label>
			<a href="#TB_inline?width=800&height=600&inlineId=woo_pp_live_api_signature_help" class="thickbox"><img src="<?php echo $help_image_url; ?>" class="help_tip" style="cursor: pointer;" height="16" width="16" data-tip="<?php _e( 'Click here for help with this option.', 'woo_pp' ); ?>"></a>
		</th>
		<td>
			<div id="woo_pp_live_api_signature_help" style="display: none;">
				<p>
					<h2><?php _e( 'Live API signature', 'woo_pp' ); ?></h2>
					<?php _e( '<p>Enter the API signature provided to you by PayPal.</p><p><strong>Note:</strong> This value is generated for you by PayPal.  You must use the signature that they give you.  This is <strong>not</strong> the same as the email address or password that you use to log in to <a href="https://www.paypal.com" target="_blank">www.paypal.com</a>.</p><p>For help on retrieving your API credentials, click on the help for the <strong>Live API credential type</strong> setting.</p>', 'woo_pp' ); ?>
				</p>
			</div>
			<fieldset>
				<legend class="screen-reader-text"><span><?php _e( 'Live API signature', 'woo_pp' ); ?></span></legend>
	...
	<tr class="woo_pp_live_certificate">
		<th>
			<label for="woo_pp_live_api_certificate"><?php _e( 'Live API certificate', 'woo_pp' ); ?></label>
			<a href="#TB_inline?width=800&height=600&inlineId=woo_pp_live_api_certificate_help" class="thickbox"><img src="<?php echo $help_image_url; ?>" class="help_tip" style="cursor: pointer;" height="16" width="16" data-tip="<?php _e( 'Click here for help with this option.', 'woo_pp' ); ?>"></a>
		</th>
		<td>
			<div id="woo_pp_live_api_certificate_help" style="display: none;">
				<p>
					<h2><?php _e( 'Live API certificate', 'woo_pp' ); ?></h2>
					<?php _e( '<p>When you request API credentials from PayPal, and you choose the API certificate option, PayPal provides you with the certificate as a file.  This file is typically called <strong>cert_key_pem.txt</strong>.  Upload the file using this setting.</p><p><strong>Note:</strong> Upload the file exactly as it was provided to you by PayPal.  The name of the file doesn\'t matter, but you must not modify the contents of the file.</p><p>For help on retrieving your API credentials, click on the help for the <strong>Live API credential type</strong> setting.</p>', 'woo_pp' ); ?>
				</p>
			</div>
			<fieldset>
				<legend class="screen-reader-text"><span><?php _e( 'Live API certificate', 'woo_pp' ); ?></span></legend>
				<p><strong><?php _e( 'Certificate status:', 'woo_pp' ); ?></strong> <?php echo $live_cert_info; ?></p>
				<p><span style="font-style: italic;"><?php _e( 'Upload a new certificate:', 'woo_pp' ); ?></span> <input type="file" name="woo_pp_live_api_certificate" id="woo_pp_live_api_certificate">
			</fieldset>
		</td>
	</tr>
	<tr class="woo_pp_live">
		<th>
			...
			<a href="#TB_inline?width=800&height=600&inlineId=woo_pp_live_subject_help" class="thickbox"><img src="<?php echo $help_image_url; ?>" class="help_tip" style="cursor: pointer;" height="16" width="16" data-tip="<?php _e( 'Click here for help with this option.', 'woo_pp' ); ?>"></a>
		</th>
		<td>
			<div id="woo_pp_live_subject_help" style="display: none;">
				<p>
					<h2><?php _e( 'Live subject', 'woo_pp' ); ?></h2>
					<?php _e( '<p>If you\'re processing transactions on behalf of someone else\'s PayPal account, enter their email address or Secure Merchant Account ID (also known as a Payer ID) here.  Generally, you must have API permissions in place with the other account in order to process anything other than "sale" transactions for them.</p><p>Most people won\'t need to use this setting.  If you\'re not sure what to put here, leave it blank.</p>', 'woo_pp' ); ?>
				</p>
			</div>
			<fieldset>
				<legend class="screen-reader-text"><span><?php _e( 'Live subject', 'woo_pp' ); ?></span></legend>
...
<?php } ?>
	...
	<tr class="woo_pp_sb">
		<th>
			<label for="woo_pp_sb_api_password"><?php _e( 'Sandbox API password', 'woo_pp' ); ?></label>
			<a href="#TB_inline?width=800&height=600&inlineId=woo_pp_sb_api_password_help" class="thickbox"><img src="<?php echo $help_image_url; ?>" class="help_tip" style="cursor: pointer;" height="16" width="16" data-tip="<?php _e( 'Click here for help with this option.', 'woo_pp' ); ?>"></a>
		</th>
		<td>
			<div id="woo_pp_sb_api_password_help" style="display: none;">
				<p>
					<h2><?php _e( 'Sandbox API password', 'woo_pp' ); ?></h2>
			...
			<fieldset>
				<legend class="screen-reader-text"><span><?php _e( 'Sandbox API password', 'woo_pp' ); ?></span></legend>
	...
	<tr class="woo_pp_sb_signature">
		<th>
			<label for="woo_pp_sb_api_signature"><?php _e( 'Sandbox API signature', 'woo_pp' ); ?></label>
			<a href="#TB_inline?width=800&height=600&inlineId=woo_pp_sb_api_signature_help" class="thickbox"><img src="<?php echo $help_image_url; ?>" class="help_tip" style="cursor: pointer;" height="16" width="16" data-tip="<?php _e( 'Click here for help with this option.', 'woo_pp' ); ?>"></a>
		</th>
		<td>
			<div id="woo_pp_sb_api_signature_help" style="display: none;">
				<p>
					<h2><?php _e( 'Sandbox API signature', 'woo_pp' ); ?></h2>
			...
			<fieldset>
				<legend class="screen-reader-text"><span><?php _e( 'Sandbox API signature', 'woo_pp' ); ?></span></legend>
	...
	<tr class="woo_pp_sb_certificate">
		<th>
			<label for="woo_pp_sb_api_certificate"><?php _e( 'Sandbox API certificate', 'woo_pp' ); ?></label>
			<a href="#TB_inline?width=800&height=600&inlineId=woo_pp_sb_api_certificate_help" class="thickbox"><img src="<?php echo $help_image_url; ?>" class="help_tip" style="cursor: pointer;" height="16" width="16" data-tip="<?php _e( 'Click here for help with this option.', 'woo_pp' ); ?>"></a>
		</th>
		<td>
			<div id="woo_pp_sb_api_certificate_help" style="display: none;">
				<p>
					<h2><?php _e( 'Sandbox API certificate', 'woo_pp' ); ?></h2>
					<?php _e( '<p>When you request API credentials from PayPal, and you choose the API certificate option, PayPal provides you with the certificate as a file.  This file is typically called <strong>cert_key_pem.txt</strong>.  Upload the file using this setting.</p><p><strong>Note:</strong> Upload the file exactly as it was provided to you by PayPal.  The name of the file doesn\'t matter, but you must not modify the contents of the file.</p><p>For help on retrieving your API credentials, click on the help for the <strong>Sandbox API credential type</strong> setting.</p>', 'woo_pp' ); ?>
				</p>
			</div>
			<fieldset>
				<legend class="screen-reader-text"><span><?php _e( 'Sandbox API certificate', 'woo_pp' ); ?></span></legend>
				<p><strong><?php _e( 'Certificate status:', 'woo_pp' ); ?></strong> <?php echo $sb_cert_info; ?></p>
				<p><span style="font-style: italic;"><?php _e( 'Upload a new certificate:', 'woo_pp' ); ?></span> <input type="file" name="woo_pp_sb_api_certificate" id="woo_pp_sb_api_certificate"></p>
			</fieldset>
		</td>
	</tr>
	<tr class="woo_pp_sb">
		<th>
			<label for="woo_pp_sb_subject"><?php _e( 'Sandbox subject', 'woo_pp' ); ?></label>
			<a href="#TB_inline?width=800&height=600&inlineId=woo_pp_sb_subject_help" class="thickbox"><img src="<?php echo $help_image_url; ?>" class="help_tip" style="cursor: pointer;" height="16" width="16" data-tip="<?php _e( 'Click here for help with this option.', 'woo_pp' ); ?>"></a>
		</th>
		<td>
			<div id="woo_pp_sb_subject_help" style="display: none;">
				<p>
					<h2><?php _e( 'Sandbox subject', 'woo_pp' ); ?></h2>
			...
			<fieldset>
				<legend class="screen-reader-text"><span><?php _e( 'Sandbox subject', 'woo_pp' ); ?></span></legend>
	...
	<tr>
		<th>
			<label for="woo_pp_enable_in_context_checkout"><?php _e( 'In-Context Checkout', 'woo_pp' ); ?></label>
			<a href="#TB_inline?width=800&height=600&inlineId=woo_pp_enable_in_context_checkout_help" class="thickbox"><img src="<?php echo $help_image_url; ?>" class="help_tip" style="cursor: pointer;" height="16" width="16" data-tip="<?php _e( 'Click here for help with this option.', 'woo_pp' ); ?>"></a>
		</th>
		<td>
			...
			<fieldset>
				<legend class="screen-reader-text"><span><?php _e( 'Enable In-Context Checkout', 'woo_pp' ); ?></span></legend>
				<input type="checkbox" name="woo_pp_icc_enabled" id="woo_pp_enable_in_context_checkout"<?php checked( $icc_enabled ); ?> value="true">
				<label for="woo_pp_enable_in_context_checkout"><?php _e( 'Enable In-Context Checkout', 'woo_pp' ); ?></label>
			</fieldset>
		</td>
	</tr>
	<tr>
		<th>
			<label for="woo_pp_button_size"><?php _e( 'Button size', 'woo_pp' ); ?></label>
			<a href="#TB_inline?width=800&height=600&inlineId=woo_pp_button_size_help" class="thickbox"><img src="<?php echo $help_image_url; ?>" class="help_tip" style="cursor: pointer;" height="16" width="16" data-tip="<?php _e( 'Click here for help with this option.', 'woo_pp' ); ?>"></a>
		</th>
		<td>
			<div id="woo_pp_button_size_help" style="display: none;">
				<p>
					<h2><?php _e( 'Button size', 'woo_pp' ); ?></h2>
	...
	<tr>
		<th>
			<label for="woo_pp_mark_size"><?php _e( 'Mark size', 'woo_pp' ); ?></label>
			<a href="#TB_inline?width=800&height=600&inlineId=woo_pp_mark_size_help" class="thickbox"><img src="<?php echo $help_image_url; ?>" class="help_tip" style="cursor: pointer;" height="16" width="16" data-tip="<?php _e( 'Click here for help with this option.', 'woo_pp' ); ?>"></a>
		</th>
		<td>
			<div id="woo_pp_mark_size_help" style="display: none;">
				<p>
					<h2><?php _e( 'Mark size', 'woo_pp' ); ?></h2>
	...
	<tr>
		<th>
			<label for="woo_pp_logo_image_url"><?php _e( 'Logo image URL', 'woo_pp' ); ?></label>
			<a href="#TB_inline?width=800&height=600&inlineId=woo_pp_logo_image_url_help" class="thickbox"><img src="<?php echo $help_image_url; ?>" class="help_tip" style="cursor: pointer;" height="16" width="16" data-tip="<?php _e( 'Click here for help with this option.', 'woo_pp' ); ?>"></a>
		</th>
		<td>
			<div id="woo_pp_logo_image_url_help" style="display: none;">
				<p>
					<h2><?php _e( 'Logo image URL', 'woo_pp' ); ?></h2>
					<?php _e( '<p>If you want PayPal to co-brand the checkout page with your logo, enter the URL of your logo image here.  The logo image must be no larger than 190x60, and should be in a format understood by most browsers (such as GIF, PNG, or JPG).</p><p><strong>Note:</strong> The URL you enter here should be on an HTTPS site (e.g., the URL should start with https://).  If it is not, some browsers may display a warning or refuse to show the image.</p>', 'woo_pp' ); ?>
				</p>
			</div>
			<fieldset>
				<legend class="screen-reader-text"><span><?php _e( 'Logo image URL', 'woo_pp' ); ?></span></legend>
	...
	<tr>
		<th>
			<label for="woo_pp_payment_action"><?php _e( 'Payment type', 'woo_pp' ); ?></label>
			<a href="#TB_inline?width=800&height=600&inlineId=woo_pp_payment_action_help" class="thickbox"><img src="<?php echo $help_image_url; ?>" class="help_tip" style="cursor: pointer;" height="16" width="16" data-tip="<?php _e( 'Click here for help with this option.', 'woo_pp' ); ?>"></a>
		</th>
		<td>
			<div id="woo_pp_payment_action_help" style="display: none;">
				<p>
					<h2><?php _e( 'Payment type', 'woo_pp' ); ?></h2>
					<?php _e( '<p>PayPal supports three payment types: Sale, Authorization, and Order.</p><ul style="list-style: disc outside; margin-left: 20px;"><li><strong>Sale:</strong> Sale transactions complete as soon as the buyer finishes checking out on your site.  The proceeds from the transaction are deposited into your PayPal account immediately (barring other factors, such as eChecks or other payment holds).  Sale transactions cannot be captured or voided, but they can be refunded.</li><li><strong>Authorization:</strong> Authorization transactions place a hold on the buyer\'s funds at the time of checkout, but does not move the funds from the buyer\'s account.  Funds are held for three days.  To move money to your account, you must perform a capture within 29 days of the time the buyer checks out.</li><li><strong>Order:</strong> Orders represent an open-to-buy on the buyer\'s account &mdash; they do not move money or hold funds, but you can authorize and capture against them later.  Orders are generally valid for 29 days from the time the buyer checks out.  Orders are handy when a product is going to be backordered or you have to split an order into multiple shipments.</li></ul>', 'woo_pp' ); ?>
				</p>
			</div>
			<fieldset>
				<legend class="screen-reader-text"><span><?php _e( 'Payment type', 'woo_pp' ); ?></span></legend>
				<select name="woo_pp_payment_action" id="woo_pp_payment_action">
					<option value="<?php echo PayPal_Settings::PaymentActionSale; ?>"<?php selected( $payment_action, PayPal_Settings::PaymentActionSale ); ?>><?php _e( 'Sale', 'woo_pp' ); ?></option>
					<option value="<?php echo PayPal_Settings::PaymentActionAuthorization; ?>"<?php selected( $payment_action, PayPal_Settings::PaymentActionAuthorization ); ?>><?php _e( 'Authorization', 'woo_pp' ); ?></option>
					<option value="<?php echo PayPal_Settings::PaymentActionOrder; ?>"<?php selected( $payment_action, PayPal_Settings::PaymentActionOrder ); ?>><?php _e( 'Order', 'woo_pp' ); ?></option>
				</select>
			</fieldset>
		</td>
	</tr>
	<tr>
		<th>
			<label for="woo_pp_allow_guest_checkout"><?php _e( 'Guest payments', 'woo_pp' ); ?></label>
			<a href="#TB_inline?width=800&height=600&inlineId=woo_pp_allow_guest_checkout_help" class="thickbox"><img src="<?php echo $help_image_url; ?>" class="help_tip" style="cursor: pointer;" height="16" width="16" data-tip="<?php _e( 'Click here for help with this option.', 'woo_pp' ); ?>"></a>
		</th>
		<td>
			<div id="woo_pp_allow_guest_checkout_help" style="display: none;">
				<p>
					<h2><?php _e( 'Allow buyers to pay without a PayPal account', 'woo_pp' ); ?></h2>
					<?php _e( '<p>This setting controls whether buyers can pay through PayPal without creating a PayPal account.</p><p>Unless you have a compelling reason to disable this setting, we recommend that you leave it enabled.</p>', 'woo_pp' ); ?>
				</p>
			</div>
			<fieldset>
				<legend class="screen-reader-text"><span><?php _e( 'Guest payments', 'woo_pp' ); ?></span></legend>
...
if ( $live_account_is_enabled_for_billing_address || $sb_account_is_enabled_for_billing_address ) {
	...
	<tr id="woo_pp_req_ba_row">
		<th>
			<label for="woo_pp_req_billing_address"><?php _e( 'Billing address', 'woo_pp' ); ?></label>
			<a href="#TB_inline?width=800&height=600&inlineId=woo_pp_req_billing_address_help" class="thickbox"><img src="<?php echo $help_image_url; ?>" class="help_tip" style="cursor: pointer;" height="16" width="16" data-tip="<?php _e( 'Click here for help with this option.', 'woo_pp' ); ?>"></a>
		</th>
		<td>
			<div id="woo_pp_req_billing_address_help" style="display: none;">
				<p>
					<h2><?php _e( 'Require buyers to provide their billing address', 'woo_pp' ); ?></h2>
					<?php _e( '<p>Normally, PayPal does not share the buyer\'s billing details with you.  However, there are times when you must collect the buyer\'s billing address to fulfill an essential business function (such as determining whether you must charge the buyer tax).</p><p>If you need the buyer\'s billing address to fulfill an essential business function, enable this setting.  Buyers will be notified during the PayPal checkout that you require their billing address to process the transaction.</p><p>Remember, PayPal will always provide you with the buyer\'s country, even if you do not enable this setting.</p><p><strong>Note: Do not enable this setting unless you have been approved by PayPal to do so.</strong></p>', 'woo_pp' ); ?>
				</p>
			</div>
			<fieldset>
				<legend class="screen-reader-text"><span><?php _e( 'Billing address', 'woo_pp' ); ?></span></legend>
				...
				<label for="woo_pp_req_billing_address"><?php _e( 'Require buyers to provide their billing address', 'woo_pp' ); ?></label>
			</fieldset>
		</td>
	</tr>
	<?php
